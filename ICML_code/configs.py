...
example1_config = SimConfig(
    gt_func=BinaryFunction([0.3, 0.4, 0.6, 0.9]),
    teacher_func=BinaryFunction([0.6, 0.9]),
    student_num_params=1,
    num_train_examples=list(range(2, 161, 2)),
    num_repeat=30000,
    delta=0.1,
...
example2_config = SimConfig(
    gt_func=BinaryFunction([0.5, 0.8, 0.9, 0.95]),
    teacher_func=BinaryFunction([0.5, 0.8]),
    student_num_params=1,
    num_train_examples=list(range(2, 91, 2)),
    num_repeat=30000,
    delta=0.05,
    tag="",
    dest_dir=""
